...
// Performance Optimization: Accept primitive coordinate numbers instead of coordinate objects.
// Default shallow comparison in React.memo will now successfully prevent re-renders when
// unaffected edges retain identical coordinate primitives during node drags.
...
export default function FunnelArchitect() {
  ...
  // Extract primitive numbers for coordinates so SvgEdge React.memo shallow equality check succeeds.
