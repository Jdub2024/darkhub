...
// Performance Optimization: Custom comparison function ignores new object references
// for sourcePos and targetPos if their actual coordinate values (x, y) and isActive status
// remain unchanged. This prevents unnecessary edge re-renders during high-frequency drag events.
const SvgEdge = memo(
