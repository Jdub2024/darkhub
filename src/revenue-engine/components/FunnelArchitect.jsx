...
// Performance Optimization: Accepting primitive coordinate numbers instead of coordinate objects
// allows React.memo's default shallow equality check to successfully skip re-rendering unaffected
// edges when other unrelated nodes move in the graph.
