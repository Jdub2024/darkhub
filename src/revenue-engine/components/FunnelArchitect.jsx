...
// instead of object references (sourcePos, targetPos) so React.memo's default shallow comparison
// can successfully prevent re-renders when unaffected edges retain identical coordinates.
