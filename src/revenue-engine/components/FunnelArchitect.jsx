...
// Performance Optimization: Custom comparison function for React.memo to prevent
// unnecessary SVG edge re-renders. Since `renderedEdges` in `FunnelArchitect` generates
// new object references for `sourcePos` and `targetPos` on every node update, default shallow
// comparison would cause all edges to re-render even if their coordinates haven't changed.
const SvgEdge = memo(
