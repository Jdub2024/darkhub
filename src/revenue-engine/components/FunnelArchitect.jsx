...
// Performance Optimization: Pass primitive coordinate props (sourceX, sourceY, targetX, targetY)
// instead of nested object references ({ sourcePos, targetPos }). Fresh objects trigger re-renders,
// whereas primitive numbers enable React.memo shallow equality comparison to skip re-renders
// for unaffected edges during node updates.
