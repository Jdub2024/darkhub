...
// Performance Optimization: Use primitive coordinate props (sourceX, sourceY, targetX, targetY)
// instead of object props ({ x, y }). React.memo performs shallow reference equality checks (===).
// When object literals are generated during state recalculations, shallow comparison fails for identical coordinates.
// Primitive props allow React.memo to skip re-rendering unaffected edges when nodes are moved.
