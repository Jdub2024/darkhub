...
// Performance optimization: Primitive coordinate props (sourceX, sourceY, targetX, targetY)
// allow React.memo shallow comparison to succeed, skipping re-renders for edges whose
// endpoints have not moved during node drag operations.
...
export default function FunnelArchitect() {
  ...
  // and pass primitive coordinate properties to SvgEdge for React.memo optimization.
