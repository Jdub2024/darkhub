...
// Performance Optimization: Custom comparison function for React.memo to ignore new object references
// for sourcePos and targetPos when coordinate values remain identical during state updates.
const SvgEdge = memo(
