...
// Optimization: Primitive props (sourceX, sourceY, targetX, targetY) allow React.memo's default
// shallow equality check to prevent re-renders of unaffected edges during node drag operations.
