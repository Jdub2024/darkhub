...
// Optimization: Primitive coordinate props (sourceX, sourceY, targetX, targetY) allow React.memo's
// default shallow comparison to prevent unnecessary re-renders when unaffected edges retain identical coordinates.
