...
// instead of object props. This allows React.memo's shallow comparison to prevent unnecessary
// re-renders of unaffected edges when other nodes in the funnel are dragged.
