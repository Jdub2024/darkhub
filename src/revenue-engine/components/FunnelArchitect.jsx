...
// Memoized to prevent re-renders when other edges or nodes move
...
// Memoized with primitive position props to optimize React.memo shallow comparison
...
export default function FunnelArchitect() {
  ...
  // Index nodes for O(1) lookup to optimize edge coordinate calculation from O(N*E) to O(N+E)
