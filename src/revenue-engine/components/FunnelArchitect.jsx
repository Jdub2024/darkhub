...
// instead of object references (sourcePos, targetPos). This enables React.memo's default
// shallow equality check to prevent re-renders of unaffected edges during drag interactions.
