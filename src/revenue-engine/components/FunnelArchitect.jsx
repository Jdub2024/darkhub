...
// Optimization: Custom comparison function for React.memo to ignore new object references
// for sourcePos/targetPos when coordinate values and isActive state are unchanged.
const SvgEdge = memo(
