...
// Performance Optimization: Using primitive coordinate props instead of object references allows
// React.memo's default shallow comparison to prevent unnecessary re-renders for unchanged edges.
