...
// `renderedEdges` builds new `sourcePos` and `targetPos` object references on every position update of ANY node.
// Comparing primitive x/y values prevents unchanged edges from re-rendering when unrelated nodes are dragged.
const SvgEdge = memo(
